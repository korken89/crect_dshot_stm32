...
INCLUDE = -I../crect/deps/mpl/src -I../crect/src -I../crect/examples/sys/inc -I.
DEFS = -DNDEBUG
...
LDFLAGS = $(COMMON) -T ../crect/examples/sys/link.ld -Wl,-Map=build/output.map --specs=nano.specs
...
all:
		...
		arm-none-eabi-g++ $(INCLUDE) $(DEFS) $(ARM_FLAGS) ../crect/examples/sys/init.cpp -o build/init.o
		arm-none-eabi-g++ $(INCLUDE) $(DEFS) $(ARM_FLAGS) ../crect/src/crect/vector_table.cpp -o build/vector.o
		arm-none-eabi-g++ $(INCLUDE) $(DEFS) $(ARM_FLAGS) ../crect/src/crect/async.cpp -o build/async.o
		arm-none-eabi-g++ $(INCLUDE) $(DEFS) $(ARM_FLAGS) ../crect/src/crect/clock.cpp -o build/clock.o
